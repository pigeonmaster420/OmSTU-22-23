...
public class MoveCommandTests
{
    ...
    public void PositiveMoveCommand()
    {
        ...
        mock.SetupProperty(m => m.pos, new System.Numerics.Vector2(12, 5));
        mock.SetupGet<System.Numerics.Vector2>(m => m.spd).Returns(new System.Numerics.Vector2(-7, 3));
        MoveCommand move = new MoveCommand(mock.Object);

        move.execute();

        Assert.Equal(new System.Numerics.Vector2(5, 8), mock.Object.pos);
    }
    [Fact]
